...
\begin{equation}
 	\zeta^* = \argmin_{\zeta \in Z_{0,g}} C(\zeta)
\end{equation}
...
When the cost function is expressed in this form, the inverse problem reduces to finding the weight vector that assigns 
